...
import type { UserResponseData, AllRoleResponseData, SetRoleData } from './type'
//枚举地址
enum API {
    //获取全部已有用户账号信息
...
//批量删除账号的接口
export const reqBatchRemoveUser = (idList: number[]) => request.delete(API.DELETEALLUSER_URL, { data: idList })